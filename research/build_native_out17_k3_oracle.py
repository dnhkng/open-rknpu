...
root=Path(__file__).resolve().parent;out=root/'fixtures/native_out17_k3';out.mkdir(exist_ok=True)
import onnx
...
init=[nh.from_array(rng.uniform(-.3,.3,shape).astype(np.float32),name) for name,shape in [('w1',(5,3,1,1)),('b1',(5,)),('w2',(17,5,3,3)),('b2',(17,))]]
