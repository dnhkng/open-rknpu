"""Native input C49..64 suite (four 16-lane planes).
...
parser.add_argument("--directory", default="research/native_c64_suite")
parser.add_argument("--cases", type=int, default=16)
args = parser.parse_args()
root = Path(__file__).resolve().parents[1] / args.directory
root.mkdir(parents=True, exist_ok=True)
rng = np.random.default_rng(110360)
...
print(f"Built {len(manifest)} native C49..64 models in {root}")
