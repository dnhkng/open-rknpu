...
| --- | --- | --- |
| Front end | `test_normalize`, `test_normalize_matrix`, `test_network`, `test_front_end_rejections` | constant folding, bias/padding folding, kernel rewrites, grouped lowering, Q/DQ handling, loud rejection of unsupported graphs |
