...
| [`benchmark/`](benchmark/README.md) | a reusable latency/throughput harness for containers (host structural mode + board `--runner bench`) | four newly measured board rows, e.g. chain_suite 0.026 ms and sequence_suite 0.078 ms (min of 5) |
