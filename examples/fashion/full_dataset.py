"""Full 10,000-image Fashion-MNIST accuracy through the board, chunked to fit flash.
...
BOARD = "/userdata/open-npu-research/fashion-calibrated"
...
images = load("t10k-images-idx3-ubyte.gz", "346e55b948d973a97e58d2351dde16a484bd415d4595297633bb08f03db6a073")
labels = load("t10k-labels-idx1-ubyte.gz", "67da17c76eaffca5446c3361aaab5c3cd6d1c2608764d35dfb1850b086bf8dd5")
...
if args.local_only:
    ...
    for start in range(0, LIMIT, args.chunk):
        ...
        adb("shell", f"cd {BOARD} && ./fashion-run {args.prefix} chunk.u8 chunk.f32 /dev/null")
