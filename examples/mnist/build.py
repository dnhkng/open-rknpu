...
Build the pinned trained MNIST hybrid example using only open host tools.
...
def main():
    ...
    if hashlib.sha256(path.read_bytes()).hexdigest() != "399f827003500f940df7c1191f44078bd14c50f2ee9af7b5d22c6b916b2ccdb8":
        raise ValueError("This model-specific example requires the pinned normalized MNIST model")
    global OUT
