...
Current baseline: 1,157 tests, 99.20 % compiler line coverage (floor 99 %), 2,328-model
...
* the host suite is 1,157 tests at 99.20% line coverage with every remaining line carrying
