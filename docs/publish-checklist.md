...
Current baseline: 760 tests, 96 % compiler line coverage (floor 95 %), 2,244-model container
...
| T7 | **Mutation testing** (`mutmut`) on the emitters and the container writer | 760 tests make this affordable; measures test *strength*, not coverage | M |
